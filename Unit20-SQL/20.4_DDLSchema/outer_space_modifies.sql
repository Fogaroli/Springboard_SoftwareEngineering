...
(
  ...
  orbits_star_id INTEGER REFERENCES stars(id) ON DELETE SET NULL,
...
CREATE TABLE moons (
  ...
  orbits_planet_id INTEGER REFERENCES planets(id) ON DELETE CASCADE
);
...
INSERT INTO moons (moon_name, orbits_planet_id) VALUES
('The Moon', 1),
('Phobos', 2),
('Deimos', 2),
('Naiad', 4),
